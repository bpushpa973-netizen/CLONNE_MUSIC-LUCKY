...
from CLONNE_MUSIC.plugins.sudo.sudoers import sudoers_list
from CLONNE_MUSIC.utils.database import get_served_chats, get_served_users, get_sudoers
from CLONNE_MUSIC.utils import bot_sys_stats
...
from CLONNE_MUSIC.utils.decorators.language import LanguageStart
from CLONNE_MUSIC.utils.formatters import get_readable_time
from CLONNE_MUSIC.utils.inline import help_pannel, private_panel, start_panel
from config import BANNED_USERS, OWNER_ID, CLONNE_PICS
...
async def start_pm(client, message: Message, _):
    ...
    if len(message.text.split()) > 1:
        ...
        [
            ...
            InlineKeyboardButton(text="ᴜᴘᴅᴀᴛᴇ", url=C_SUPPORT_CHANNEL),
        ],
        [
