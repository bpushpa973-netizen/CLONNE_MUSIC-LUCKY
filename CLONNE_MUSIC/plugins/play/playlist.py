...
from CLONNE_MUSIC import Carbon, app
from CLONNE_MUSIC.utils.decorators.language import language, languageCB
from CLONNE_MUSIC.utils.inline.playlist import (
    botplaylist_markup,
    get_playlist_markup,
    warning_markup,
)
from CLONNE_MUSIC.utils.pastebin import LUCKYBin
from CLONNE_MUSIC.utils.stream.stream import stream
...
async def add_playlist(client, message: Message, _):
    ...
    if "https://youtu.be" in query:
        ...
        from CLONNE_MUSIC import YouTube
...
@app.on_callback_query(filters.regex("LUCKY_playlist") & ~BANNED_USERS)
@languageCB
